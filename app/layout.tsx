...
export const metadata = {
  ...baseMetadata,
  title: {
    default: "IEEE PESCE - Advancing Technology for Humanity",
    template: "%s | IEEE PESCE Student Branch"
  },
  description: "IEEE PESCE Student Branch - Empowering students to innovate, collaborate, and lead in the world of technology at PES College of Engineering, Mandya.",
